        ...
        <div class="card-content">
          <h5 class="card-title mb-2">
            <svg class="icono-catalogo" xmlns="http://www.w3.org/2000/svg">
              <use href="<?php echo $base; ?>/assets/img/sprite.svg#paleta"></use>
            </svg>
            Pintura acrílica decorativa
          </h5>
          <!-- Enlace solo en el texto -->
          <a href="pintura-acrilica-decorativa.php" class="fw-semibold text-white text-decoration-none">
            EXPLORAR PRODUCTOS →
          </a>
        </div>
      </div>
    ...
    <div class="card h-100 card-hover-up">
      <div class="card-bg bg-pasta-modelable">
        <div class="card-content">
          ...
          <!-- Enlace solo en el texto -->
          <a href="pasta-modelable.php" class="fw-semibold text-white text-decoration-none">
            EXPLORAR PRODUCTOS →
          </a>
        </div>
      </div>
    ...
    <div class="card h-100 card-hover-up">
      <div class="card-bg bg-sellos-decorativos">
        <div class="card-content">
          ...
          <!-- Enlace solo en el texto -->
          <a href="sellos-decorativos.php" class="fw-semibold text-white text-decoration-none">
            EXPLORAR PRODUCTOS →
          </a>
        </div>
      </div>
    ...
    <div class="card h-100 card-hover-up">
      <div class="card-bg bg-plantillas-stencil">
        <div class="card-content">
          ...
          <!-- Enlace solo en el texto -->
          <a href="plantillas.php" class="fw-semibold text-white text-decoration-none">
            EXPLORAR PRODUCTOS →
          </a>
        </div>
      </div>
    ...
    <div class="card h-100 card-hover-up">
      <div class="card-bg bg-goma-eva">
        <div class="card-content">
          ...
          <!-- Enlace solo en el texto -->
          <a href="goma-eva.php" class="fw-semibold text-white text-decoration-none">
            EXPLORAR PRODUCTOS →
          </a>
        </div>
      </div>
    ...
    <div class="card h-100 card-hover-up">
      <div class="card-bg bg-soportes-decorar">
        <div class="card-content">
          ...
          <!-- Enlace solo en el texto -->
          <a href="soportes-para-decorar.php" class="fw-semibold text-white text-decoration-none">
            EXPLORAR PRODUCTOS →
          </a>
        </div>
      </div>
