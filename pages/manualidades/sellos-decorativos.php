    ...
    <div id="carouselProductoDetalle" class="carousel slide" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="<?php echo $base; ?>/assets/img/catalogo/manualidades/sellos-decorativos/sellos-madera-motivos-florales.jpg" class="d-block w-100 rounded" alt="Sellos florales de madera">
        </div>
        <div class="carousel-item">
          <img src="<?php echo $base; ?>/assets/img/catalogo/manualidades/sellos-decorativos/caja-sellos-abecedario-madera.jpg" class="d-block w-100 rounded" alt="Caja de sellos de letras">
        </div>
        <div class="carousel-item">
          <img src="<?php echo $base; ?>/assets/img/catalogo/manualidades/sellos-decorativos/kit-sellos-silicona-bloques-metacrilato.jpg" class="d-block w-100 rounded" alt="Kit de sellos de silicona">
        </div>
        <div class="carousel-item">
          <img src="<?php echo $base; ?>/assets/img/catalogo/manualidades/sellos-decorativos/pack-tampones-tinta-varios-colores.jpg" class="d-block w-100 rounded" alt="Tinta de colores para sellos">
        </div>
      </div>
