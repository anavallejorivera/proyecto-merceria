    ...
    <div id="carouselProductoDetalle" class="carousel slide" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="<?php echo $base; ?>/assets/img/catalogo/manualidades/pasta-modelable/pack-pasta-moldeable-bloque-blanco.jpg" class="d-block w-100 rounded" alt="Bloque de Pasta Modelable">
        </div>
        <div class="carousel-item">
          <img src="<?php echo $base; ?>/assets/img/catalogo/manualidades/pasta-modelable/set-herramientas-modelado-manualidades.jpg" class="d-block w-100 rounded" alt="Herramientas de Modelado">
        </div>
        <div class="carousel-item">
          <img src="<?php echo $base; ?>/assets/img/catalogo/manualidades/pasta-modelable/figuras-decorativas-pasta-secado-aire.jpg" class="d-block w-100 rounded" alt="Figuras Decorativas de Pasta">
        </div>
      </div>
