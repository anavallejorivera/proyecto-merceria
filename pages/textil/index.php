        ...
        <div class="card h-100 card-hover-up">
          <div class="card-bg bg-telas-por-tipo">
            <div class="card-content">
              ...
              <a href="telas-por-tipo.php" class="fw-semibold text-white text-decoration-none">
                EXPLORAR PRODUCTOS →
              </a>
            </div>
          </div>
        ...
        <div class="card h-100 card-hover-up">
          <div class="card-bg bg-telas-por-uso">
            <div class="card-content">
              ...
              <!-- Enlace solo en el texto -->
              <a href="telas-por-uso.php" class="fw-semibold text-white text-decoration-none">
                EXPLORAR PRODUCTOS →
              </a>
            </div>
          </div>
        ...
        <div class="card h-100 card-hover-up">
          <div class="card-bg bg-forros-y-guatas">
            <div class="card-content">
              ...
              <!-- Enlace solo en el texto -->
              <a href="forros-y-guantes.php" class="fw-semibold text-white text-decoration-none">
                EXPLORAR PRODUCTOS →
              </a>
            </div>
          </div>
        ...
        <div class="card h-100 card-hover-up">
          <div class="card-bg bg-retales-varios">
            <div class="card-content">
              ...
              <!-- Enlace solo en el texto -->
              <a href="retales-varios.php" class="fw-semibold text-white text-decoration-none">
                EXPLORAR PRODUCTOS →
              </a>
            </div>
          </div>
        ...
        <div class="card h-100 card-hover-up">
          <div class="card-bg bg-encajes-y-pasamaneria">
            <div class="card-content">
              ...
              <!-- Enlace solo en el texto -->
              <a href="encajes-y-pasamaneria.php" class="fw-semibold text-white text-decoration-none">
                EXPLORAR PRODUCTOS →
              </a>
            </div>
          </div>
