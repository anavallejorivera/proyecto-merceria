    ...
    <div id="carouselProductoDetalle" class="carousel slide" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="<?php echo $base; ?>/assets/img/catalogo/merceria/cintas-elasticos/cinta-raso-roja.png" class="d-block w-100 rounded" alt="Cinta de raso roja decorativa">
        </div>
        <div class="carousel-item">
          <img src="<?php echo $base; ?>/assets/img/catalogo/merceria/cintas-elasticos/goma-elastica-blanca.png" class="d-block w-100 rounded" alt="Goma elástica blanca para prendas">
        </div>
        <div class="carousel-item">
          <img src="<?php echo $base; ?>/assets/img/catalogo/merceria/cintas-elasticos/metro-flexometro.png" class="d-block w-100 rounded" alt="Metro o flexómetro para costura">
        </div>
      </div>
