    ...
    <div id="carouselProductoDetalle" class="carousel slide" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="<?php echo $base; ?>/assets/img/catalogo/merceria/agujas-y-ganchillo/agujas-punto-madera.png" class="d-block w-100 rounded" alt="Agujas de punto de madera">
        </div>
        <div class="carousel-item">
          <img src="<?php echo $base; ?>/assets/img/catalogo/merceria/agujas-y-ganchillo/cinta-metrica-pequena.png" class="d-block w-100 rounded" alt="Cinta métrica pequeña para costura">
        </div>
        <div class="carousel-item">
          <img src="<?php echo $base; ?>/assets/img/catalogo/merceria/agujas-y-ganchillo/ganchillo-ergonomico.png" class="d-block w-100 rounded" alt="Ganchillo ergonómico para tejer cómodamente">
        </div>
        <div class="carousel-item">
          <img src="<?php echo $base; ?>/assets/img/catalogo/merceria/agujas-y-ganchillo/ganchillos-colores.png" class="d-block w-100 rounded" alt="Set de ganchillos de colores variados">
        </div>
        <div class="carousel-item">
          <img src="<?php echo $base; ?>/assets/img/catalogo/merceria/agujas-y-ganchillo/marcadores-puntos.png" class="d-block w-100 rounded" alt="Marcadores de puntos para tejido">
        </div>
        <div class="carousel-item">
          <img src="<?php echo $base; ?>/assets/img/catalogo/merceria/agujas-y-ganchillo/set-agujas-estuche.png" class="d-block w-100 rounded" alt="Set de agujas en estuche">
        </div>
      </div>
