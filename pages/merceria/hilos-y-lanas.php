    ...
    <div id="carouselProductoDetalle" class="carousel slide" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="<?php echo $base; ?>/assets/img/catalogo/merceria/hilos-lanas/cono-hilo-industrial-blanco.jpg" class="d-block w-100 rounded" alt="Cono de hilo industrial blanco">
        </div>
        <div class="carousel-item">
          <img src="<?php echo $base; ?>/assets/img/catalogo/merceria/hilos-lanas/madejas-lana-natural-beige.jpg" class="d-block w-100 rounded" alt="Madejas de lana natural color beige">
        </div>
        <div class="carousel-item">
          <img src="<?php echo $base; ?>/assets/img/catalogo/merceria/hilos-lanas/ovillos-lana-colores-variados.jpg" class="d-block w-100 rounded" alt="Ovillos de lana de colores variados">
        </div>
        <div class="carousel-item">
          <img src="<?php echo $base; ?>/assets/img/catalogo/merceria/hilos-lanas/set-carretes-hilo-coser.jpg" class="d-block w-100 rounded" alt="Set de carretes de hilo para coser">
        </div>
      </div>
