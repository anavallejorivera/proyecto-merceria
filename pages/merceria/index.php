        ...
        <div class="card h-100 card-hover-up">
          <div class="card-bg bg-hilos-lanas">
            <div class="card-content">
              ...
              <a href="hilos-y-lanas.php" class="fw-semibold text-white text-decoration-none">
                EXPLORAR PRODUCTOS →
              </a>
            </div>
          </div>
        ...
        <div class="card h-100 card-hover-up">
          <div class="card-bg bg-agujas-ganchillos">
            <div class="card-content">
              ...
              <a href="agujas-y-ganchillos.php" class="fw-semibold text-white text-decoration-none">
                EXPLORAR PRODUCTOS →
              </a>
            </div>
          </div>
        ...
        <div class="card h-100 card-hover-up">
          <div class="card-bg bg-botones-cierres">
            <div class="card-content">
              ...
              <a href="botones-y-cierres.php" class="fw-semibold text-white text-decoration-none">
                EXPLORAR PRODUCTOS →
              </a>
            </div>
          </div>
        ...
        <div class="card h-100 card-hover-up">
          <div class="card-bg bg-cintas-elasticos">
            <div class="card-content">
              ...
              <a href="cintas-y-elasticos.php" class="fw-semibold text-white text-decoration-none">
                EXPLORAR PRODUCTOS →
              </a>
            </div>
          </div>
        ...
        <div class="card h-100 card-hover-up">
          <div class="card-bg bg-accesorios-costura">
            <div class="card-content">
              ...
              <a href="accesorios-de-costura.php" class="fw-semibold text-white text-decoration-none">
                EXPLORAR PRODUCTOS →
              </a>
            </div>
          </div>
