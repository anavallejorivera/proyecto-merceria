    ...
    <div id="carouselProductoDetalle" class="carousel slide" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="<?php echo $base; ?>/assets/img/catalogo/merceria/accesorios-costura/alfiletero-tomate.png" class="d-block w-100 rounded" alt="Alfiletero en forma de tomate">
        </div>
        <div class="carousel-item">
          <img src="<?php echo $base; ?>/assets/img/catalogo/merceria/accesorios-costura/caja-imperdibles.png" class="d-block w-100 rounded" alt="Caja con imperdibles variados">
        </div>
        <div class="carousel-item">
          <img src="<?php echo $base; ?>/assets/img/catalogo/merceria/accesorios-costura/cinta-metrica.png" class="d-block w-100 rounded" alt="Cinta métrica flexible de costura">
        </div>
        <div class="carousel-item">
          <img src="<?php echo $base; ?>/assets/img/catalogo/merceria/accesorios-costura/dedal-metalico.png" class="d-block w-100 rounded" alt="Dedal metálico para costura a mano">
        </div>
        <div class="carousel-item">
          <img src="<?php echo $base; ?>/assets/img/catalogo/merceria/accesorios-costura/descosedor.png" class="d-block w-100 rounded" alt="Descosedor para trabajos de precisión">
        </div>
        <div class="carousel-item">
          <img src="<?php echo $base; ?>/assets/img/catalogo/merceria/accesorios-costura/tijeras-costura.png" class="d-block w-100 rounded" alt="Tijeras de costura profesional">
        </div>
        <div class="carousel-item">
          <img src="<?php echo $base; ?>/assets/img/catalogo/merceria/accesorios-costura/tiza-sastre.png" class="d-block w-100 rounded" alt="Tiza de sastre para marcar telas">
        </div>
      </div>
