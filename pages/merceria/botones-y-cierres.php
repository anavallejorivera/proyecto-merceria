    ...
    <div id="carouselProductoDetalle" class="carousel slide" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="<?php echo $base; ?>/assets/img/catalogo/merceria/botones-cierres/botones-surtidos.png" class="d-block w-100 rounded" alt="Botones surtidos de varios colores y tamaños">
        </div>
        <div class="carousel-item">
          <img src="<?php echo $base; ?>/assets/img/catalogo/merceria/botones-cierres/corchetes-presion.png" class="d-block w-100 rounded" alt="Corchetes de presión metálicos">
        </div>
        <div class="carousel-item">
          <img src="<?php echo $base; ?>/assets/img/catalogo/merceria/botones-cierres/cremallera-gris.png" class="d-block w-100 rounded" alt="Cremallera gris de plástico">
        </div>
        <div class="carousel-item">
          <img src="<?php echo $base; ?>/assets/img/catalogo/merceria/botones-cierres/hebillas-metalicas.png" class="d-block w-100 rounded" alt="Hebillas metálicas para cierres de cinturones o bolsos">
        </div>
      </div>
