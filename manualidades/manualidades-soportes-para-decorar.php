    ...
    <div id="carouselProductoDetalle" class="carousel slide" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="assets/img/catalogo/manualidades/soportes-para-decorar/maletin-carton-kraft-manualidades.jpg" class="d-block w-100 rounded" alt="Maletín de cartón kraft para manualidades">
        </div>
        <div class="carousel-item">
          <img src="assets/img/catalogo/manualidades/soportes-para-decorar/marco-fotos-carton-basico.jpg" class="d-block w-100 rounded" alt="Marco de fotos de cartón básico">
        </div>
        <div class="carousel-item">
          <img src="assets/img/catalogo/manualidades/soportes-para-decorar/caja-madera-tapa-cristal-organizadora.jpg" class="d-block w-100 rounded" alt="Caja de madera con tapa de cristal para organizar">
        </div>
        <div class="carousel-item">
          <img src="assets/img/catalogo/manualidades/soportes-para-decorar/casa-pajaros-madera-decorar.jpg" class="d-block w-100 rounded" alt="Casa de pájaros de madera para decorar">
        </div>
        <div class="carousel-item">
          <img src="assets/img/catalogo/manualidades/soportes-para-decorar/letra-madera-decorativa-a.jpg" class="d-block w-100 rounded" alt="Letra decorativa de madera">
        </div>
      </div>
