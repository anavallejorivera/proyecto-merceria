    ...
    <div id="carouselProductoDetalle" class="carousel slide" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="assets/img/catalogo/manualidades/plantillas-stencils/coleccion-plantillas-stencil-motivos-variados.jpg" class="d-block w-100 rounded" alt="Colección de plantillas stencil">
        </div>
        <div class="carousel-item">
          <img src="assets/img/catalogo/manualidades/plantillas-stencils/kit-herramientas-estarcido-rodillo-pinceles.jpg" class="d-block w-100 rounded" alt="Kit de estarcido con rodillo y pinceles">
        </div>
        <div class="carousel-item">
          <img src="assets/img/catalogo/manualidades/plantillas-stencils/set-pinturas-y-pasta-textura-relieve.jpg" class="d-block w-100 rounded" alt="Set de pinturas y pasta de relieve">
        </div>
        <div class="carousel-item">
          <img src="assets/img/catalogo/manualidades/plantillas-stencils/muestras-decoracion-stencil-madera-carton.jpg" class="d-block w-100 rounded" alt="Decoración con stencil sobre madera y cartón">
        </div>
      </div>
